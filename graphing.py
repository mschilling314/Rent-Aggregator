...
if __name__=="__main__":
    ...
    print_price_per_day_for_floor_plan(average_rent_by_floor_plan, "SC2")
    graph_price_per_day(average_rent_by_floor_plan, yaxis="Average Price", floor_plan_name="SC2")